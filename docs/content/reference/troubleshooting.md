...
Most of these come down to network reality or how icpc serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

icpc rate-limits like any public site. icpc already paces
...
Where a surface is gated, icpc reads a cookie or token you supply
...
`icpc`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what icpc actually did
